...
import { View, SafeAreaView, FlatList, Text, Button, TouchableOpacity, TextInput, Image } from 'react-native';
    ...
    render() {
        ...
        return (
            <SafeAreaView style={{ flex: 1 }}>
                ...
                <View style={{ height: 200, marginRight: 10, marginLeft: 10, borderColor: 'gary', borderRadius: 5, borderWidth: 1, marginTop: 2 }}>
                    <Text style={{ height: 20, color: 'black', marginTop: 10, marginLeft: 10 }}>Date birth</Text>
